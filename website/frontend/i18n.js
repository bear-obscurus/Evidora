const TRANSLATIONS = {
    ...
    fr: {
        ...
        error_claim_too_long: "Affirmation trop longue (max. 500 caractères).",
        ...
        // UI-Strings (ergänzt 2026-07-07, Audit #7 — vorher DE-Fallback)
        chars_remaining: "caractères restants",
        tips_btn: "Conseils",
        tips_motto: "« Ce qui peut être dit peut être dit clairement. » — Wittgenstein",
        tips_1: "<strong>Soyez précis :</strong> « Les vaccins sont dangereux » → « Les vaccins à ARNm augmentent le risque d'infarctus »",
        tips_2: "<strong>Indiquez chiffres et période :</strong> « L'inflation est élevée » → « L'inflation dans l'UE a dépassé 5 % en 2024 »",
        tips_3: "<strong>Une affirmation par vérification :</strong> ne combinez pas plusieurs énoncés dans une même phrase.",
        tips_4: "<strong>Omettez la source :</strong> « Selon Twitter... » → saisissez simplement l'affirmation elle-même.",
        claim_display_label: "Affirmation vérifiée",
        error_empty: "L'affirmation ne peut pas être vide.",
        disclaimer_default: "Ceci est une vérification automatique et ne remplace pas une rédaction professionnelle de fact-checking.",
        btn_export_pdf: "Enregistrer en PDF",
        btn_share: "Copier le lien",
        share_copied: "Lien copié !",
        toast_pdf: "Préparation du PDF …",
        toast_link_copied: "Lien copié dans le presse-papiers.",
        toast_link_failed: "Impossible de copier le lien.",
        toast_mail_opened: "Ouverture de votre client de messagerie.",
        btn_report: "Signaler le résultat",
        report_subject: "Résultat erroné",
        report_claim: "Affirmation",
        report_verdict: "Évaluation",
        report_summary: "Résumé",
        report_reason: "Qu'est-ce qui ne va pas dans le résultat ? (veuillez décrire)",
        dev_notice: "Ce projet est en développement actif. L'analyse IA de cette version en ligne utilise l'API Mistral Cloud (serveurs UE, Paris).",
        footer_main: "Evidora.eu — Fact-check européen",
        footer_note: "Vérification automatique — ne remplace pas une rédaction professionnelle de fact-checking",
        ...
        austria_edition_link: "🇦🇹 Österreich Edition — voir toutes les sources autrichiennes",
        // Rechtstexte bleiben Deutsch (rechtlich maßgeblich); Hinweis-Banner:
        legal_lang_notice: "Ce document juridique n'est disponible qu'en allemand (version juridiquement contraignante).",
    },
    ...
    it: {
        ...
        error_claim_too_long: "Affermazione troppo lunga (max. 500 caratteri).",
        ...
        tips_btn: "Consigli",
        tips_motto: "« Ciò che può essere detto, può essere detto chiaramente. » — Wittgenstein",
        tips_1: "<strong>Sii specifico:</strong> « I vaccini sono pericolosi » → « I vaccini a mRNA aumentano il rischio di infarto »",
        tips_2: "<strong>Indica numeri e periodo:</strong> « L'inflazione è alta » → « Nel 2024 l'inflazione nell'UE ha superato il 5 % »",
        tips_3: "<strong>Un'affermazione per controllo:</strong> non combinare più enunciati in una stessa frase.",
        tips_4: "<strong>Ometti la fonte:</strong> « Secondo Twitter... » → inserisci semplicemente l'affermazione stessa.",
        claim_display_label: "Affermazione verificata",
        error_empty: "L'affermazione non può essere vuota.",
        disclaimer_default: "Questa è una verifica automatica e non sostituisce una redazione professionale di fact-checking.",
        btn_export_pdf: "Salva come PDF",
        btn_share: "Copia link",
        share_copied: "Link copiato!",
        toast_pdf: "Preparazione del PDF …",
        toast_link_copied: "Link copiato negli appunti.",
        toast_link_failed: "Impossibile copiare il link.",
        toast_mail_opened: "Apertura del client di posta.",
        btn_report: "Segnala risultato",
        report_subject: "Risultato errato",
        report_claim: "Affermazione",
        report_verdict: "Valutazione",
        report_summary: "Riepilogo",
        report_reason: "Cosa c'è di sbagliato nel risultato? (descrivi)",
        dev_notice: "Questo progetto è in sviluppo attivo. L'analisi IA di questa versione online utilizza l'API Mistral Cloud (server UE, Parigi).",
        footer_main: "Evidora.eu — Fact-checking europeo",
        footer_note: "Verifica automatica — non sostituisce una redazione professionale di fact-checking",
        footer_opensource: "Open source su GitHub",
        privacy_link: "Privacy",
        imprint_link: "Note legali",
        sources_link: "Fonti",
        disclaimer_link: "Avvertenze",
        austria_edition_link: "🇦🇹 Österreich Edition — vedi tutte le fonti austriache",
        // Rechtstexte bleiben Deutsch (rechtlich maßgeblich); Hinweis-Banner:
        legal_lang_notice: "Questo documento legale è disponibile solo in tedesco (versione giuridicamente vincolante).",
    },
};
