const TRANSLATIONS = {
    de: {
        ...
        // Footer
        footer_main: "Evidora.eu — Europäischer Faktencheck | Quellen: PubMed, Cochrane, WHO, EMA, ECDC, Eurostat, EZB, UNHCR, EEA, Copernicus, OECD, GADMO, DataCommons, EUvsDisinfo, EFCSN",
    ...
    en: {
        ...
        // Footer
        footer_main: "Evidora.eu — European Fact Check | Sources: PubMed, Cochrane, WHO, EMA, ECDC, Eurostat, ECB, UNHCR, EEA, Copernicus, OECD, GADMO, DataCommons, EUvsDisinfo, EFCSN",
