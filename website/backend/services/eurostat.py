...
DATASET_MAP = {
    ...
    "einwanderung": {
        ...
        "label": "Einwanderung (gesamt)",
        "label_en": "Immigration (total)",
        "params": {"citizen": "TOTAL", "agedef": "COMPLET", "age": "TOTAL", "sex": "T", "lastTimePeriod": "5"},
        "unit": "Personen",
    },
    "immigration": {
        "dataset": "migr_imm1ctz",
    ...
    # Handel / Sanktionen
    # ("handel"/"trade" → ext_lt_maineu ENTFERNT 2026-07-07: der Datensatz
    #  lieferte für Extra-EU/World über ALLE Indikatoren (Balance/Export/
    #  Import) leere Werte — toter Connector. Außenhandel ist ohnehin über
    #  UNComtrade + WITS + CEPII BACI + welthandel_pack abgedeckt.)
    "sanktionen": {
        "dataset": "nama_10_gdp",
    ...
    "bildung": {
        ...
        "label": "Tertiärer Bildungsabschluss (25-64 J.)",
        "label_en": "Tertiary Educational Attainment (25-64)",
        "params": {"sex": "T", "age": "Y25-64", "isced11": "ED5-8", "lastTimePeriod": "5"},
        "unit": "%",
    },
    "education": {
        "dataset": "edat_lfse_03",
    ...
    "studenten": {
        ...
        "params": {"sex": "T", "isced11": "ED5-8", "worktime": "TOTAL", "sector": "TOT_SEC", "lastTimePeriod": "5"},
        "unit": "Personen",
    },
    "students": {
        "dataset": "educ_uoe_enrt01",
    ...
    "reichste": {
        ...
        "params": {"na_item": "B1GQ", "unit": "CP_PPS_EU27_2020_HAB", "lastTimePeriod": "5"},
        "unit": "KKS pro Kopf",
    },
    "reichsten": {
        "dataset": "nama_10_pc",
    ...
    "armut": {
        ...
        "params": {"rskpovth": "B_60", "statinfo": "MED_EI", "unit": "PC", "sex": "T", "age": "TOTAL", "lastTimePeriod": "5"},
        "unit": "%",
    },
    "poverty": {
        "dataset": "ilc_li02",
    ...
    "ungleichheit": {
        ...
        "params": {"age": "TOTAL", "lastTimePeriod": "5"},
        "unit": "Gini (0-100)",
    },
    "inequality": {
        "dataset": "ilc_di12",
    ...
    "lohn": {
        ...
        "params": {"sizeclas": "GE10", "sex": "T", "unit": "EUR", "lastTimePeriod": "3"},
        "unit": "EUR/Stunde",
    },
    "verdienst": {
        "dataset": "earn_ses_pub2s",
    ...
    "hochtechnologie": {
        ...
        "params": {"nace_r1": "HTC", "unit": "PC_EMP", "sex": "T", "lastTimePeriod": "5"},
        "unit": "% gesamt",
    },
    "high-tech": {
        "dataset": "htec_emp_nat",
